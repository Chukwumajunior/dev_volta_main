...
@section('body-content')
    <div x-data="{ activeFaq: 1 }">
            ...
            <div class="container max-w-7xl mx-auto px-4">
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div data-aos="fade-right">
                        <span class="inline-block px-4 py-2 mb-6 text-sm font-semibold text-[#0070f3] bg-[#0070f3]/10 rounded-full">OUR STORY</span>
                        <h1 class="text-5xl md:text-6xl font-bold mb-6 text-[#0a2540] leading-tight">
                            Building <span class="text-[#0070f3]">Digital Solutions</span><br>That Drive <span class="text-[#0070f3]">Growth</span>
                        </h1>
                        ...
                        <div class="flex flex-wrap gap-4">
                            <a href="#mission" class="bg-[#0070f3] hover:bg-[#0a2540] text-white px-8 py-4 rounded-full font-semibold transition-all hover:-translate-y-1 shadow-lg">Our Mission</a>
                    ...
                    <div data-aos="fade-left" class="relative">
                        ...
                        <div class="absolute -bottom-6 -left-6 bg-white p-5 rounded-2xl shadow-xl">
                            <div class="flex items-center gap-3">
                                <div class="w-12 h-12 bg-[#0070f3]/10 rounded-full flex items-center justify-center">
                                    <i class="bi bi-building text-2xl text-[#0070f3]"></i>
                                </div>
                                <div>
        ...
        <section class="py-20 bg-white">
            <div class="container max-w-7xl mx-auto px-4">
                <div class="grid lg:grid-cols-2 gap-16 items-center">
                    <div>
                        <span class="inline-block px-4 py-2 mb-4 text-sm font-semibold text-[#0070f3] bg-[#0070f3]/10 rounded-full">WHO WE ARE</span>
                        <h2 class="text-4xl md:text-5xl font-bold mb-6 text-[#0a2540]">More Than Just A <span class="text-[#0070f3]">Tech Company</span></h2>
                        ...
                        <div class="grid grid-cols-2 gap-6 mt-8">
                            <div>
                                <div class="text-4xl font-bold text-[#0070f3]">50+</div>
                                <p class="text-gray-600">Projects Completed</p>
                            </div>
                            <div>
                                <div class="text-4xl font-bold text-[#0070f3]">98%</div>
                                <p class="text-gray-600">Client Satisfaction</p>
                            </div>
                            <div>
                                <div class="text-4xl font-bold text-[#0070f3]">5+</div>
                                <p class="text-gray-600">Years Experience</p>
                            </div>
                            <div>
                                <div class="text-4xl font-bold text-[#0070f3]">24/7</div>
            ...
            <div class="container max-w-7xl mx-auto px-4">
                <div class="grid lg:grid-cols-2 gap-8">
                    <div class="bg-white rounded-3xl p-10 shadow-lg" data-aos="fade-right">
                        <div class="w-16 h-16 bg-[#0070f3]/10 rounded-2xl flex items-center justify-center mb-6">
                            <i class="bi bi-bullseye text-3xl text-[#0070f3]"></i>
                        </div>
                    ...
                    <div class="bg-[#0a2540] rounded-3xl p-10 shadow-lg text-white" data-aos="fade-left">
                        <div class="w-16 h-16 bg-[#0070f3]/20 rounded-2xl flex items-center justify-center mb-6">
                            <i class="bi bi-eye text-3xl text-[#0070f3]"></i>
                        </div>
        ...
        <section class="py-20 bg-white">
            <div class="container max-w-7xl mx-auto px-4">
                <div class="text-center mb-16">
                    <span class="inline-block px-4 py-2 mb-4 text-sm font-semibold text-[#0070f3] bg-[#0070f3]/10 rounded-full">WHY US</span>
                    <h2 class="text-4xl md:text-5xl font-bold mb-4 text-[#0a2540]">The <span class="text-[#0070f3]">Voltafrik</span> Difference</h2>
                    <p class="text-xl text-gray-600 max-w-3xl mx-auto">We don't just write code. We build long-term partnerships.</p>
                </div>

                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div class="text-center">
                        <div class="w-16 h-16 bg-[#0070f3]/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                            <i class="bi bi-shield-check text-3xl text-[#0070f3]"></i>
                        </div>
                    ...
                    <div class="text-center">
                        <div class="w-16 h-16 bg-[#0070f3]/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                            <i class="bi bi-code-slash text-3xl text-[#0070f3]"></i>
                        </div>
                    ...
                    <div class="text-center">
                        <div class="w-16 h-16 bg-[#0070f3]/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                            <i class="bi bi-clock-history text-3xl text-[#0070f3]"></i>
                        </div>
                    ...
                    <div class="text-center">
                        <div class="w-16 h-16 bg-[#0070f3]/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                            <i class="bi bi-people text-3xl text-[#0070f3]"></i>
                        </div>
        ...
        <section class="py-20 bg-gray-50">
            <div class="container max-w-7xl mx-auto px-4">
                <div class="text-center mb-16">
                    <span class="inline-block px-4 py-2 mb-4 text-sm font-semibold text-[#0070f3] bg-[#0070f3]/10 rounded-full">THE TEAM</span>
                    <h2 class="text-4xl md:text-5xl font-bold mb-4 text-[#0a2540]">Meet The <span class="text-[#0070f3]">Experts</span></h2>
                    ...
                    @foreach($teamMembers as $member)
                        <div class="bg-white rounded-2xl p-6 text-center shadow-sm hover:shadow-xl transition-all">
                            <div class="w-32 h-32 mx-auto mb-4">
                                <img src="{{ asset('storage/' . $member->image) }}" class="w-full h-full rounded-full object-cover border-4 border-[#0070f3]/20" alt="{{ $member->title }}">
                            </div>
                            <h4 class="font-bold text-lg">{{ $member->title }}</h4>
                            <p class="text-[#0070f3] font-semibold text-sm mb-2">{{ $member->body }} </p>
                        </div>
                    @endforeach
                </div>
            </div>
        ...
        <section class="py-20 bg-gray-50">
            <div class="container max-w-4xl mx-auto px-4">
                <div class="text-center mb-12">
                    <span class="inline-block px-4 py-2 mb-4 text-sm font-semibold text-[#0070f3] bg-[#0070f3]/10 rounded-full">FAQ</span>
                    <h2 class="text-4xl md:text-5xl font-bold mb-4 text-[#0a2540]">Common <span class="text-[#0070f3]">Questions</span></h2>
                </div>
        ...
        <section class="py-20 bg-gradient-to-r from-[#0a2540] to-[#1a3650] text-white relative overflow-hidden">
            ...
            <div class="container max-w-7xl mx-auto px-4 text-center relative z-10">
                <h2 class="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                    Ready to Build Your <span class="text-[#0070f3]">Digital Future</span>?
                </h2>
                ...
                <div class="flex flex-wrap justify-center gap-4">
                    <a href="/contact" class="bg-[#0070f3] hover:bg-white hover:text-[#0a2540] text-white px-10 py-5 rounded-full font-bold text-lg transition-all hover:-translate-y-1 shadow-xl">Start Your Project</a>
        ...
        <div class="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-50 md:hidden">
            <a href="/contact" class="bg-[#0070f3] text-white px-8 py-4 rounded-full font-bold shadow-2xl flex items-center gap-3 whitespace-nowrap">
