                ...
                <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-5">
                        ...
                        <div x-show="type==='store'" x-cloak x-transition>
                            ...
                            <input type="number" name="price" id="price" x-model="price" step="0.01" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#f57813] focus:ring-4 focus:ring-orange-100 outline-none transition" placeholder="Enter price">
