...
@section('title', 'Let\'s Work Together | Voltafrik Web Development')
            ...
            <div class="container max-w-7xl mx-auto px-4">
                ...
                <div class="grid lg:grid-cols-12 gap-8 items-start">
                    <div class="lg:col-span-5" data-aos="fade-right">
                        <h2 class="text-3xl md:text-4xl font-extrabold mb-4">Connect With Us</h2>
                        <p class="text-gray-600 text-lg mb-8">Follow our journey and see what we're building. Stay updated on our latest web projects and tech insights.</p>
                        <div class="space-y-3">
                            <a href="https://github.com/voltafrik" target="_blank" rel="noopener noreferrer" class="flex items-center gap-3 px-5 py-3 bg-gray-50 hover:bg-[#0a2540] group rounded-full transition-all duration-300">
                                <i class="bi bi-github text-xl group-hover:text-white"></i>
                                <span class="font-semibold group-hover:text-white">GitHub</span>
                            </a>
                            ...
                            <a href="https://www.linkedin.com/in/chukwuma-innocent-91aaaa284/" target="_blank" rel="noopener noreferrer" class="flex items-center gap-3 px-5 py-3 bg-gray-50 hover:bg-[#0a2540] group rounded-full transition-all duration-300">
                                ...
                                <span class="font-semibold group-hover:text-white">LinkedIn</span>
                            </a>
                        ...
                        <div class="mt-8 p-5 bg-blue-50 rounded-2xl border border-blue-100">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <span class="text-xs bg-white px-3 py-1.5 rounded-full border border-gray-200">Laravel</span>
                                <span class="text-xs bg-white px-3 py-1.5 rounded-full border border-gray-200">Vue.js</span>
                                <span class="text-xs bg-white px-3 py-1.5 rounded-full border border-gray-200">Alpine.js</span>
                                <span class="text-xs bg-white px-3 py-1.5 rounded-full border border-gray-200">Tailwind</span>
                                <span class="text-xs bg-white px-3 py-1.5 rounded-full border border-gray-200">MySQL</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="lg:col-span-7" data-aos="fade-left">
                        <div class="bg-white rounded-3xl p-8 md:p-10 shadow-2xl border border-gray-100">
                            <h3 class="text-2xl font-bold mb-6">Tell Us About Your Project</h3>
