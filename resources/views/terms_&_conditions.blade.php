            ...
            <div class="container max-w-4xl mx-auto px-4">
                <div class="bg-gray-50 rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100">
                    ...
                    <div class="mt-8 p-6 bg-white rounded-2xl border border-gray-200">
                        <p class="text-gray-700 mb-0">If you have any questions regarding our terms, feel free to <a href="{{ url('/contact') }}" class="text-[#0070f3] font-bold hover:underline">contact us</a>.</p>
                    </div>
                </div>
            </div>
        </section>
